...
namespace Senai_SpMedicalGroup.Controllers
{
    ...
    public class ConsultasController : ControllerBase
    {
        ...
        [Authorize(Roles = "2")]
        [HttpPost]
        public IActionResult Post(Consultum novaConsultaModel)
        {
            try
            {
        ...
        public IActionResult AlterSituation(int idConsulta, Situacao consultaModel)
        {
        ...
        [HttpPatch("alterar/descricao/{idConsulta}")]
         public IActionResult AlterDescription(int idConsulta, Consultum descricao)
        {
            try
            {
                if (idConsulta <= 0)
                ...
                bool altered = _consultaRepository.AtualizarDescricao(idConsulta, idusuario, descricao);
